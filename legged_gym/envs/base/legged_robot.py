...
class LeggedRobot(BaseTask):
    ...
    def post_physics_step(self):
        ...
        if self.num_build_envs > 0 and self.enable_terminate:
    ...
    def _post_physics_step_callback(self):
        ...
        if self.cfg.commands.heading_command:
            ...
            self.commands[:, 2] = torch.clip(1.3 * wrap_to_pi(self.commands[:, 3] - heading), -1.3, 1.3)
    ...
    def set_commands(self,envs_idx,commands):
        self.commands[envs_idx, 0] = commands[0]
        self.commands[envs_idx, 1] = commands[1]
        self.commands[envs_idx, 3] = commands[2] - 3.14
    ...
    def _resample_commands(self, env_ids):
        ...
        self.commands[env_ids, 3] = gs_rand_float(*self.cfg.commands.ranges.heading, (len(env_ids),), self.device)
